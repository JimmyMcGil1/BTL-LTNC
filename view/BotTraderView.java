...
import marketmodel.BotAutoTradeInvestor;
import marketmodel.IndividualInvestor;

public class BotTraderView extends JFrame {
	/*
	 * provide ui for user
	 * provide the mean for user to get message from market
	 */
	//Attributes:
	private BotAutoTradeInvestor investor;
	private JPanel titlePanel;
	private JPanel logPanel;
	private JTextPane MsgTP;
	
	//Methods:
	public BotTraderView(BotAutoTradeInvestor investor) {
